  ...
  return (
    ...
    >
      <div
        ...
        style={{ height: Math.max(300, dimensions.height + 80) }}
        tabIndex={0}
        onKeyDown={onKeyDown}
      >
            ...
            {items.map((item, i) => {
              ...
              return (
                <motion.div
                  ...
                  style={{ width: dimensions.width, height: dimensions.height, zIndex, transformStyle: "preserve-3d" }}
      ...
      {showDots ? (
        <div className="mt-6 flex items-center justify-center gap-3">
            ...
            {items.map((it, idx) => {
              ...
              return (
                <button
                  ...
                  className={cn("h-2 w-2 rounded-full transition", on ? "bg-[#00AEEF]" : "bg-white/30 hover:bg-white/50")}
          ...
          {activeItem.href ? (
            <a href={activeItem.href} target="_blank" rel="noreferrer" className="text-gray-400 hover:text-white transition" aria-label="Open link">
    ...
    <div className="relative h-full w-full">
      <div className="absolute inset-0">
        {item.imageSrc ? (
          ...
          <div className="flex h-full w-full items-center justify-center bg-gray-800 text-sm text-gray-400">No image</div>
        )}
      </div>
