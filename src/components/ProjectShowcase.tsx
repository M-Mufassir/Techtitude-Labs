  ...
  return (
    <div className="project-showcase-wrap" ref={containerRef}>
      ...
      <header className="project-showcase-header">
        <h1 className="fluid font-display font-bold whitespace-pre-line">{projectShowcaseContent.headerTitle}</h1>
        <h2 className="fluid font-mono text-gray-400">{projectShowcaseContent.headerSubtitle}</h2>
      </header>
      ...
      <section className="scroll-track" ref={trackRef}>
        <div className="sticky-content">
          <div className="grid">
            ...
            <div className="layer">
              <div><img src={projectShowcaseImages["image-1"]} alt="Work 1" /></div>
              <div><img src={projectShowcaseImages["image-2"]} alt="Work 2" /></div>
              <div><img src={projectShowcaseImages["image-3"]} alt="Work 3" /></div>
              <div><img src={projectShowcaseImages["image-4"]} alt="Work 4" /></div>
              <div><img src={projectShowcaseImages["image-5"]} alt="Work 5" /></div>
              <div><img src={projectShowcaseImages["image-6"]} alt="Work 6" /></div>
            </div>

            {/* Layer 2: Inner columns (6 items) */}
            <div className="layer">
              <div><img src={projectShowcaseImages["image-7"]} alt="Work 7" /></div>
              <div><img src={projectShowcaseImages["image-8"]} alt="Work 8" /></div>
              <div><img src={projectShowcaseImages["image-9"]} alt="Work 9" /></div>
              <div><img src={projectShowcaseImages["image-10"]} alt="Work 10" /></div>
              <div><img src={projectShowcaseImages["image-11"]} alt="Work 11" /></div>
              <div><img src={projectShowcaseImages["image-12"]} alt="Work 12" /></div>
            </div>

            {/* Layer 3: Center column top and bottom (2 items) */}
            <div className="layer">
              <div><img src={projectShowcaseImages["image-13"]} alt="Work 13" /></div>
