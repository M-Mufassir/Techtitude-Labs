  ...
  const projects = [
    {
      ...
      description: "We architected a high-throughput transaction engine capable of processing 50,000 requests per second with 99.999% uptime. The system integrates directly with Visa and Mastercard network rails.",
      metrics: [
    ...
    },
    {
      ...
      description: "A complete overhaul of OmniHealth's infrastructure. We built a secure, HIPAA-compliant video consultation platform featuring end-to-end encryption and real-time medical record syncing.",
      metrics: [
    ...
    },
    {
      ...
      description: "We developed a machine learning pipeline that ingests global weather, port traffic, and historical data to predict supply chain disruptions 3 weeks before they happen.",
      metrics: [
